...
LIBDOMAINKEYS=../libdomainkeys-0.69
...
auto-ccld.sh: \
conf-cc conf-ld conf-cxx conf-ldx warn-auto.sh
	( cat warn-auto.sh; \
	echo CC=\'`head -1 conf-cc`\'; \
	echo LD=\'`head -1 conf-ld`\'; \
	echo CXX=\'`head -1 conf-cxx`\'; \
	echo LDX=\'`head -1 conf-ldx`\' \
	) > auto-ccld.sh
...
compile-cxx: \
make-cxx warn-auto.sh systype
	( cat warn-auto.sh; ./make-cxx "`cat systype`" ) > \
	compile-cxx
	chmod 755 compile-cxx
...
loadx: \
make-loadx warn-auto.sh systype
	( cat warn-auto.sh; ./make-loadx "`cat systype`" ) > loadx
	chmod 755 loadx
...
make-cxx: \
make-cxx.sh auto-ccld.sh
	cat auto-ccld.sh make-cxx.sh > make-cxx
	chmod 755 make-cxx
...
make-loadx: \
make-loadx.sh auto-ccld.sh
	cat auto-ccld.sh make-loadx.sh > make-loadx
	chmod 755 make-loadx
...
$(LIBDOMAINKEYS)/libdomainkeys.a env.a getln.a control.o stralloc.a dns.lib libdkim.a
	g++ -L/usr/local/lib \
	-o qmail-dkim qmail-dkim.o triggerpull.o dkimdns.o fmtqfn.o now.o \
...
qmail-dkim.o: \
compile compile-cxx qmail-dkim.c readwrite.h sig.h exit.h open.h seek.h fmt.h \
qmail.h alloc.h substdio.h datetime.h now.h datetime.h triggerpull.h extra.h \
...
substdio.a error.a str.a fs.a auto_qmail.o \
base64.o md5c.o hmac_md5.o failedDN.o \
dns.lib socket.lib
	./load qmail-remote control.o constmap.o timeoutread.o \
	timeoutwrite.o timeoutconn.o tcpto.o now.o dns.o ip.o \
        tls.o ssl_timeoutio.o -L/usr/local/lib -lssl -lcrypto \
	ipalloc.o strsalloc.o ipme.o quote.o ndelay.a case.a sig.a open.a \
	lock.a seek.a getln.a stralloc.a alloc.a substdio.a error.a \
        base64.o md5c.o hmac_md5.o failedDN.o -lhiredis \
...
dkim: loadx libdkim.a dkim.o dkimdns.o
	./loadx dkim $(LFLAGS) -L. dkimdns.o libdkim.a `cat dns.lib` -lcrypto
...
.cpp.o:
	./compile-cxx -I. -DHAVE_EVP_SHA256 $(CFLAGS) $(INCL) $<
