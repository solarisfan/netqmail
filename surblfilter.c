...
static substdio ssin = SUBSTDIO_FDBUF((int(*)())read, 0, ssinbuf, sizeof ssinbuf);
static char     ssoutbuf[512];
static substdio ssout = SUBSTDIO_FDBUF((int(*)())write, 1, ssoutbuf, sizeof ssoutbuf);
static char     sserrbuf[512];
static substdio sserr = SUBSTDIO_FDBUF((int(*)())write, 2, sserrbuf, sizeof(sserrbuf));
